...
public class WalletController {
    ...
    public ResponseEntity<WalletDTO> paySpecificBills(@RequestBody SpecificPaymentRequest request) {
        return ResponseEntity.ok(walletService.paySpecificBills(request));
    }
}